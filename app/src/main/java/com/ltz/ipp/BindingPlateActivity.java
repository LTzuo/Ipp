 ...
 * 绑定车牌
 */
public class BindingPlateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_binding_plate);

        mInputView = (InputView)findViewById(R.id.input_view);
        mProvinceView = (EditText) findViewById(R.id.province_value);

        final Button lockTypeButton = (Button) findViewById(R.id.lock_type);
        ...
        switch (id) {
            ...
            case R.id.popup_keyboard:
                if (mPopupKeyboard.isShown()) {
                    mPopupKeyboard.dismiss(BindingPlateActivity.this);
                } else {
                    mPopupKeyboard.show(BindingPlateActivity.this);
                }
                break;
